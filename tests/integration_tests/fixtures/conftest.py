...
@pytest.fixture
async def ha_test_environment(hass: Any) -> AsyncGenerator[Any]:
...
@pytest.fixture
def temp_image_file() -> Generator[str]:
...
@pytest.fixture
async def error_printer_server() -> AsyncGenerator[VirtualPrinterServer]:
