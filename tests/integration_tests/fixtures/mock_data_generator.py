...
class MockDataGenerator:
    ...
    def generate_barcode_data(barcode_type: str = "CODE128") -> str:
        ...
        if barcode_type.upper() == "CODE128":
            ...
            ) + MockDataGenerator._calculate_ean13_check_digit(
            ...
            ) + MockDataGenerator._calculate_upca_check_digit(
    ...
    def generate_test_image(
        width: int = 200, height: int = 100, format_type: str = "receipt"
    ) -> Image.Image:
        ...
        if format_type == "receipt":
            ...
            draw.ellipse(
                [width // 2 - 20, height // 2 - 20, width // 2 + 20, height // 2 + 20], fill="blue"
            )
    ...
    def generate_print_job_data(job_type: str) -> dict[str, Any]:
        ...
        if job_type == "text":
            ...
            return {"type": "feed", "data": {"lines": random.randint(1, 10)}}
        ...
        if trigger_type == "state":
            ...
            return {
                ...
                "action": {
                    ...
                    "data": {"data": MockDataGenerator.generate_qr_data(), "size": 6},
                },
            }
            ...
            return {
                "id": f"test_automation_{random.randint(1000, 9999)}",
                "alias": "Event Print",
                "trigger": {"platform": "event", "event_type": "test_print_event"},
                "condition": [],
                "action": {
                    "service": "escpos_printer.print_barcode",
                    "data": {"code": MockDataGenerator.generate_barcode_data(), "bc": "CODE128"},
                },
            }
